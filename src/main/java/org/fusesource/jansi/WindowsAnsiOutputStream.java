...
public final class WindowsAnsiOutputStream extends AnsiOutputStream {
    ...
    private static final short[] ANSI_FOREGROUND_COLOR_MAP = new short[] { (short) 0, Kernel32.FOREGROUND_RED, Kernel32.FOREGROUND_GREEN, WindowsAnsiOutputStream.FOREGROUND_YELLOW, Kernel32.FOREGROUND_BLUE, WindowsAnsiOutputStream.FOREGROUND_MAGENTA, WindowsAnsiOutputStream.FOREGROUND_CYAN, WindowsAnsiOutputStream.FOREGROUND_WHITE};
    private static final short[] ANSI_BACKGROUND_COLOR_MAP = new short[] { (short) 0, Kernel32.BACKGROUND_RED, Kernel32.BACKGROUND_GREEN, WindowsAnsiOutputStream.BACKGROUND_YELLOW, Kernel32.BACKGROUND_BLUE, WindowsAnsiOutputStream.BACKGROUND_MAGENTA, WindowsAnsiOutputStream.BACKGROUND_CYAN, WindowsAnsiOutputStream.BACKGROUND_WHITE};
    ...
    protected void processSetForegroundColor(int color) throws IOException {
        this.info.attributes = (short) (this.info.attributes & -8 | WindowsAnsiOutputStream.ANSI_FOREGROUND_COLOR_MAP[color]);
        this.applyAttribute();
    }

    protected void processSetBackgroundColor(int color) throws IOException {
        this.info.attributes = (short) (this.info.attributes & -113 | WindowsAnsiOutputStream.ANSI_BACKGROUND_COLOR_MAP[color]);
        this.applyAttribute();
    }
