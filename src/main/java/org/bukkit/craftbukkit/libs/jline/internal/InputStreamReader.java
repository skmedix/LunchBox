    ...
    public InputStreamReader(InputStream in, String enc) throws UnsupportedEncodingException {
        ...
        if (enc == null) {
            ...
            try {
                ...
                throw (UnsupportedEncodingException) (new UnsupportedEncodingException(enc)).initCause(illegalargumentexception);
            }
    ...
    public boolean ready() throws IOException {
        ...
        synchronized (this.lock) {
            if (this.in == null) {
                ...
                try {
                    flag = this.bytes.hasRemaining() || this.in.available() > 0;
                } catch (IOException ioexception) {
                    return false;
                }
