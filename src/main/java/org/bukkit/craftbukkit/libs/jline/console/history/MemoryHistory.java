...
public class MemoryHistory implements History {
    ...
    public ListIterator entries(int index) {
        return new MemoryHistory.EntriesIterator(index - this.offset, (MemoryHistory.SyntheticClass_1) null);
    }
    ...
    private class EntriesIterator implements ListIterator {
        ...
        EntriesIterator(int x1, MemoryHistory.SyntheticClass_1 x2) {
            this(x1);
        }
    }
