    ...
    protected final Object convert(String argument) {
        if (this.converter == null) {
            ...
            try {
                ...
                throw new OptionArgumentConversionException(this.options(), argument, this.converter.valueType(), reflectionexception);
            } catch (ValueConversionException valueconversionexception) {
                throw new OptionArgumentConversionException(this.options(), argument, this.converter.valueType(), valueconversionexception);
            }
        }
    }
