...
abstract class AbstractOptionSpec implements OptionSpec {
    ...
    protected abstract Object convert(String s);

    abstract void handleOption(OptionParser optionparser, ArgumentList argumentlist, OptionSet optionset, String s);

    abstract boolean acceptsArguments();

    abstract boolean requiresArgument();

    abstract void accept(OptionSpecVisitor optionspecvisitor);
