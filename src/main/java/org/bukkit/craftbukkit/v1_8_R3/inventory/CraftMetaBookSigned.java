...
class CraftMetaBookSigned extends CraftMetaBook implements BookMeta {
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftMetaBookSigned.$SWITCH_TABLE$org$bukkit$Material;

        if (CraftMetaBookSigned.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
            ...
            CraftMetaBookSigned.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
