...
class CraftMetaPotion extends CraftMetaItem implements PotionMeta {
    ...
    public List getCustomEffects() {
        return this.hasCustomEffects() ? ImmutableList.copyOf((Collection) this.customEffects) : ImmutableList.of();
    }
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftMetaPotion.$SWITCH_TABLE$org$bukkit$Material;

        if (CraftMetaPotion.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
            ...
            CraftMetaPotion.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
