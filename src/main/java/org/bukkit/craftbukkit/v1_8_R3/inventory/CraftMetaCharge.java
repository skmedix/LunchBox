...
class CraftMetaCharge extends CraftMetaItem implements FireworkEffectMeta {
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftMetaCharge.$SWITCH_TABLE$org$bukkit$Material;

        if (CraftMetaCharge.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
            ...
            CraftMetaCharge.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
