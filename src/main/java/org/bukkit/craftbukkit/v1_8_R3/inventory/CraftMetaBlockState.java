...
public class CraftMetaBlockState extends CraftMetaItem implements BlockStateMeta {
    ...
    CraftMetaBlockState(CraftMetaItem meta, Material material) {
        ...
        if (meta instanceof CraftMetaBlockState && ((CraftMetaBlockState) meta).material == material && material != Material.SIGN && material != Material.COMMAND) {
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftMetaBlockState.$SWITCH_TABLE$org$bukkit$Material;

        if (CraftMetaBlockState.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
            ...
            CraftMetaBlockState.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
