...
class CraftMetaEnchantedBook extends CraftMetaItem implements EnchantmentStorageMeta {
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftMetaEnchantedBook.$SWITCH_TABLE$org$bukkit$Material;

        if (CraftMetaEnchantedBook.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
            ...
            CraftMetaEnchantedBook.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
