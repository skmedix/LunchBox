...
public final class CraftItemFactory implements ItemFactory {
    ...
    static final Collection KNOWN_NBT_ATTRIBUTE_NAMES;
    ...
    public boolean equals(ItemMeta meta1, ItemMeta meta2) {
        if (meta1 == meta2) {
            ...
            return meta1 == null ? ((CraftMetaItem) meta2).isEmpty() : (meta2 == null ? ((CraftMetaItem) meta1).isEmpty() : this.equals((CraftMetaItem) meta1, (CraftMetaItem) meta2));
        }
    }
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        ...
        if (CraftItemFactory.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
