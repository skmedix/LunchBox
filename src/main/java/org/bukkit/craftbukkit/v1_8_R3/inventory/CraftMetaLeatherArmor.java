...
class CraftMetaLeatherArmor extends CraftMetaItem implements LeatherArmorMeta {
    ...
    CraftMetaLeatherArmor(Map map) {
        super(map);
        this.color = CraftItemFactory.DEFAULT_LEATHER_COLOR;
        this.setColor((Color) CraftMetaItem.SerializableMeta.getObject(Color.class, map, CraftMetaLeatherArmor.COLOR.BUKKIT, true));
    }
    ...
    static int[] $SWITCH_TABLE$org$bukkit$Material() {
        int[] aint = CraftMetaLeatherArmor.$SWITCH_TABLE$org$bukkit$Material;

        if (CraftMetaLeatherArmor.$SWITCH_TABLE$org$bukkit$Material != null) {
            return aint;
        } else {
            ...
            CraftMetaLeatherArmor.$SWITCH_TABLE$org$bukkit$Material = aint1;
            return aint1;
        }
    }
}
