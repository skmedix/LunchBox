...
public class PistonBaseMaterial extends MaterialData implements Directional, Redstone {
    ...
    static int[] $SWITCH_TABLE$org$bukkit$block$BlockFace() {
        int[] aint = PistonBaseMaterial.$SWITCH_TABLE$org$bukkit$block$BlockFace;

        if (PistonBaseMaterial.$SWITCH_TABLE$org$bukkit$block$BlockFace != null) {
            return aint;
        } else {
            ...
            PistonBaseMaterial.$SWITCH_TABLE$org$bukkit$block$BlockFace = aint1;
            return aint1;
        }
    }
}
