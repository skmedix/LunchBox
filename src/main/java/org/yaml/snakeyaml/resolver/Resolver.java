...
public class Resolver {
    ...
    public Tag resolve(NodeId kind, String value, boolean implicit) {
        ...
        switch (Resolver.SyntheticClass_1.$SwitchMap$org$yaml$snakeyaml$nodes$NodeId[kind.ordinal()]) {
        case 1:
            return Tag.STR;
    ...
    static class SyntheticClass_1 {
        ...
        static {
            try {
                Resolver.SyntheticClass_1.$SwitchMap$org$yaml$snakeyaml$nodes$NodeId[NodeId.scalar.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
                Resolver.SyntheticClass_1.$SwitchMap$org$yaml$snakeyaml$nodes$NodeId[NodeId.sequence.ordinal()] = 2;
