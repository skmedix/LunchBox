...
public class SpigotWorldConfig {
    ...
    private void antiXray() {
        this.antiXray = this.getBoolean("anti-xray.enabled", true);
        this.log("Anti X-Ray: " + this.antiXray);
        this.engineMode = this.getInt("anti-xray.engine-mode", 1);
        this.log("\tEngine Mode: " + this.engineMode);
        if (SpigotConfig.version < 5) {
            this.set("anti-xray.blocks", (Object) null);
        }

        this.hiddenBlocks = this.getList("anti-xray.hide-blocks", Arrays.asList(new Integer[] { Integer.valueOf(14), Integer.valueOf(15), Integer.valueOf(16), Integer.valueOf(21), Integer.valueOf(48), Integer.valueOf(49), Integer.valueOf(54), Integer.valueOf(56), Integer.valueOf(73), Integer.valueOf(74), Integer.valueOf(82), Integer.valueOf(129), Integer.valueOf(130)}));
        this.log("\tHidden Blocks: " + this.hiddenBlocks);
        this.replaceBlocks = this.getList("anti-xray.replace-blocks", Arrays.asList(new Integer[] { Integer.valueOf(1), Integer.valueOf(5)}));
        this.log("\tReplace Blocks: " + this.replaceBlocks);
    ...
    private void initHunger() {
        this.walkExhaustion = (float) this.getDouble("hunger.walk-exhaustion", 0.2D);
        this.sprintExhaustion = (float) this.getDouble("hunger.sprint-exhaustion", 0.8D);
        this.combatExhaustion = (float) this.getDouble("hunger.combat-exhaustion", 0.3D);
        this.regenExhaustion = (float) this.getDouble("hunger.regen-exhaustion", 3.0D);
    }
