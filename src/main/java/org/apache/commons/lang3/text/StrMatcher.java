...
public abstract class StrMatcher {
    ...
    public static StrMatcher charSetMatcher(String s) {
        return (StrMatcher) (StringUtils.isEmpty(s) ? StrMatcher.NONE_MATCHER : (s.length() == 1 ? new StrMatcher.CharMatcher(s.charAt(0)) : new StrMatcher.CharSetMatcher(s.toCharArray())));
    }

    public static StrMatcher stringMatcher(String s) {
        return (StrMatcher) (StringUtils.isEmpty(s) ? StrMatcher.NONE_MATCHER : new StrMatcher.StringMatcher(s));
    }
