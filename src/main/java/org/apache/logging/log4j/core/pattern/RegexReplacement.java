...
public final class RegexReplacement {
    ...
    private RegexReplacement(Pattern pattern, String s) {
    ...
    @PluginFactory
    public static RegexReplacement createRegexReplacement(@PluginAttribute("regex") String s, @PluginAttribute("replacement") String s1) {
        if (s == null) {
            ...
            return new RegexReplacement(pattern, s1);
        }
    }
}
