...
public final class ConsoleAppender extends AbstractOutputStreamAppender {
    ...
    private static ConsoleAppender.ConsoleManagerFactory factory = new ConsoleAppender.ConsoleManagerFactory((ConsoleAppender.ConsoleManagerFactory) null);
    ...
    private static OutputStreamManager getManager(boolean follow, ConsoleAppender.Target target, Layout layout) {
        ...
        return OutputStreamManager.getManager(target.name() + "." + follow, (Object) (new ConsoleAppender.FactoryData(os, type, layout)), (ManagerFactory) ConsoleAppender.factory);
    }
    ...
    private static OutputStream getOutputStream(boolean follow, ConsoleAppender.Target target) {
        ...
        try {
            ...
            throw new IllegalStateException("Unsupported default encoding " + enc, unsupportedencodingexception);
        }
    ...
    private static class ConsoleManagerFactory implements ManagerFactory {
        ...
        ConsoleManagerFactory(ConsoleAppender.ConsoleManagerFactory consoleappender_consolemanagerfactory) {
            this();
        }
    }
