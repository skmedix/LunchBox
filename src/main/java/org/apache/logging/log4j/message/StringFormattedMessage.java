...
public class StringFormattedMessage implements Message {
    ...
    public StringFormattedMessage(String s, Object... aobject) {
    ...
    protected String formatMessage(String s, Object... aobject) {
        try {
            return String.format(s, aobject);
        } catch (IllegalFormatException illegalformatexception) {
            StringFormattedMessage.LOGGER.error("Unable to format msg: " + s, (Throwable) illegalformatexception);
            return s;
        }
    }
